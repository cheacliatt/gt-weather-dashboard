// Event listener for the button on the search bar
  ...
  function generateButton() {
    ...
    var cityButtonEl = $("<li class='list-group-item'>").text(cityEl);
    // $("cityButtonEl").attr("id='city-prime'");
    cityButtonEl.on("click", function(){
      generateWeather($(this).text());
    })
    $("#city-list").prepend(cityButtonEl);
    // When i click the city generated by the button click
    // It 
